...
pub fn test_parse_3(){
    ...
    obj.get_values_mut().insert("EDSVersion".to_string(), "3.0".to_string());
...
pub fn test_parse_4(){
    let mut obj = StructuredFileObject::new("test".to_string());
    obj.get_values_mut().insert("EDSVersion".to_string(), "4.0".to_string());
...
pub fn test_parse_unsupported(){
    let mut obj = StructuredFileObject::new("test".to_string());
    obj.get_values_mut().insert("EDSVersion".to_string(), "4.1".to_string());
...
pub fn test_parse_invalid(){
    let mut obj = StructuredFileObject::new("test".to_string());
    obj.get_values_mut().insert("EDSVersion".to_string(), "aaa".to_string());
